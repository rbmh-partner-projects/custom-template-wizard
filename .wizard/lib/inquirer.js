            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, preferredLanguage === 'TypeScript'
                            ? enum_1.CustomScriptLanguage.TYPESCRIPT
                            : enum_1.CustomScriptLanguage.JAVASCRIPT];
            }
        });
    }); },
            ...
            switch (_a.label) {
                    ...
                    question = [
                        {
                            ...
                            choices: [
                                "Vanilla ".concat(preferredLanguage === enum_1.CustomScriptLanguage.JAVASCRIPT
                                    ? 'JavaScript'
                                    : 'TypeScript'),
                                'Preact',
                                'Svelte',
                ...
                case 1:
                    ...
                    if (preferredFramework === 'Preact')
                        return [2 /*return*/, enum_1.CustomScriptFramework.PREACT];
                    if (preferredFramework === 'Svelte')
                        return [2 /*return*/, enum_1.CustomScriptFramework.SVELTE];
                    if (preferredFramework === 'Vue')
                        return [2 /*return*/, enum_1.CustomScriptFramework.VUE];
                    return [2 /*return*/, enum_1.CustomScriptFramework.VANILLA];
            }
        });
    }); }
};
