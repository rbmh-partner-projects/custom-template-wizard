...
/*
 * This example demonstrates the usage of JotForm in Custom Scripts. This should not be used in a production environment
 */
const jotForm = {
  ...
  getJotFormSubmissionData: async function (userSilodId) {
