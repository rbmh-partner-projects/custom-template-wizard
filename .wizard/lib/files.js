...
var getFilesInDirectory = function (dir) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                if (!fs_extra_1["default"].pathExists(dir)) {
                    return [2 /*return*/, []];
                }
                files = [];
                _i = 0;
            ...
            case 2:
                ...
                file = _a[_i];
                absPath = path_1["default"].join(dir, file);
                return [4 /*yield*/, fs_extra_1["default"].stat(absPath)];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    appPath = path_1["default"].join('.', 'src');
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all(filesInApp.map(function (path) { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, fs_extra_1["default"].stat(path)];
                                    case 1:
                                        fileStat = _a.sent();
                                        return [2 /*return*/, {
                                                path: path,
